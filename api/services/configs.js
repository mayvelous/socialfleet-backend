module.exports = {
    ...
    // OAuth 1.0
    TWITTER_KEY: process.env.TWITTER_KEY || 'P4zDubkVjyh9P6PFJXANzALfX',
    TWITTER_SECRET: process.env.TWITTER_SECRET || 'KNHG28YjKm4FsauWsfC2Zm4k76xKV2rbi5mQN2ZJhOSVp3HEGv',

    schedulerInterval: process.env.SCHEDULER_INTERVAL || 5000
};